...
Version  : 2.0.0
Release  : 1
URL      : http://download.savannah.nongnu.org/releases/openexr/ilmbase-2.0.0.tar.gz
Source0  : http://download.savannah.nongnu.org/releases/openexr/ilmbase-2.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1502484525
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libHalf.so.10
/usr/lib64/libHalf.so.10.0.0
/usr/lib64/libIex-2_0.so.10
/usr/lib64/libIex-2_0.so.10.0.0
/usr/lib64/libIexMath-2_0.so.10
/usr/lib64/libIexMath-2_0.so.10.0.0
/usr/lib64/libIlmThread-2_0.so.10
/usr/lib64/libIlmThread-2_0.so.10.0.0
/usr/lib64/libImath-2_0.so.10
/usr/lib64/libImath-2_0.so.10.0.0
